...
def extract_card_info(content):
    ...
    # GrowthCardPaymentMethod — displayText (last4) + paymentOptionLogo (brand)
    m = re.search(
    ...
    # displayText digits + nearby paymentOptionLogo
...
def check_account(cookie_dict):
    ...
    try:
        ...
        # Card — from /YourAccount Growth data
